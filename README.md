...
Приложение работает с БД и реализовано с помощью JDBCTemplate и SQL.
...
The application works with the database and is implemented using JDBCTemplate and SQL.
